    ...
    items: [
      {
        ...
        options: [
          ...
          'Have you seen the fresh fish yet?',
          'Did you bring the shopping list?',
          'Should we check the dairy case?'
        ]
      },
      {
        id: 2,
        ...
        options: [
          ...
          'The market is quite busy now.',
          'These prices are very good here.',
          'The produce looks fresh this week.'
        ]
      },
      {
        id: 3,
        ...
        options: [
          ...
          'Should we check the price first?',
      ...
      },
      {
        ...
        options: [
          ...
          "Let's check the produce first.",
          "Do you see the price tag?",
          "This looks really fresh here."
        ]
      },
      {
        id: 5,
        ...
        options: [
          ...
          'Should we check the price?',
          'Have you found the produce?'
        ]
      },
      {
        id: 6,
      ...
      },
      {
        ...
        options: [
          ...
          "The produce looks fresh this morning.",
          "We should check another aisle first.",
      ...
      },
      {
        ...
        options: [
          ...
          'Have you seen the fresh produce yet?',
          'Should we look at different brands?',
      ...
      },
      {
        ...
        options: [
          ...
          'Should we check another brand first?',
          'Do you need help finding things?',
          'Have you seen the price here?'
        ]
      },
      {
        id: 10,
        ...
        options: [
          ...
          'The market seems pretty busy.',
          'Did you check the other aisle?',
          'Should we get a shopping cart?'
        ]
      },
      {
        id: 11,
        ...
        options: [
          ...
          'Have you seen the fresh bread?',
          'Should we check another store?',
          'The produce looks very good.'
        ]
      },
      {
        id: 12,
        ...
        options: [
          ...
          "The produce section looks nice.",
          "Should we check the price first?"
        ]
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          "The store seems busy today.",
          "Have you checked the price yet?",
          "Should we try different brands?"
        ]
      },
      {
        id: 16,
      ...
      },
      {
        ...
        options: [
          ...
          'Have you seen the fresh produce?',
          'The market seems quiet today.',
          'Should we check the price list?'
        ]
      },
      {
        id: 18,
        ...
        options: [
          ...
          "The produce section looks fresh.",
          "Have you found what you needed?",
          "Should we try another store first?"
        ]
      },
      {
        id: 19,
      ...
      },
      {
        ...
        options: [
          ...
          'The produce looks very fresh here.',
          'Have you found everything okay?',
          'Should we check another aisle?'
        ]
      }
    ]
  }
